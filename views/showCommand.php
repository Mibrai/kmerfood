                        ...
                        for($i = 0; $i <= $counter; $i++){
                            ...
                            <div class='modal-dialog  modal-dialog-centered' role='document'>
                                ...
                                <div class='modal-header'>
                                    <h5 class='modal-title' id='exampleModalCenterTitle'><img src='../images/commande.png' alt='' /> Commande N° ".$command->getId()."</h5>
                                    ...
                                    <form>
                                        ...
                                        <div class='form-row'>
                                            <div class='form-group col-md-12'>
                                                ...
                                                <input type='date' id='delivry' name='delivry' class='form-control' id='delivryDate' placeholder='YYYY-mm-dd'>
                                            </div>
                                        </div>
                                        ...
                                        <div class='form-row'>
                                            <div class='form-group col-md-12' id='col_result'>

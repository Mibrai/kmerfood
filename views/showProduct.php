                ...
                <?php 
                        ...
                        for($i = 0; $i <= $counter; $i++){
                            ...
                            <tr id='tr_cmd' data-toggle='modal' data-target='#modal".$product->getId()."'>
                                ...
                                <td><img src='../".$product->getImagePath()."' alt='Image' /></td>
                            ...
                            <div class='modal-dialog  modal-dialog-centered' role='document'>
                                ...
                                <div class='modal-header'>
                                    <h5 class='modal-title' id='exampleModalCenterTitle'><img src='../images/commande.png' alt='' /> Article : ".$product->getName()."</h5>

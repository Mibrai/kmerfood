        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light navbar-default bootsnav">
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.html"><img src="images/images/logo-removebg-previewsmall.PNG" class="logo" alt=""></a>
                </div>
            ...
            <div class="row">
                <div class="col-lg-8 col-sm-12">
                    <div class="contact-form-right">
                        ...
                        <p>Faites nous part de vos remarques et autres besoins et nous en ferons notre priorité</p>
                        <form id="contactForm">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="name" name="name" placeholder="Entrez votre nom" required data-error="Entrez votre nom">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input type="text" placeholder="Entrez votre mail" id="email" class="form-control" name="name" required data-error="Entrez votre mail">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="subject" name="name" placeholder="Sujet de votre message" required data-error="Sujet de votre message">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <textarea class="form-control" id="message" placeholder="Entrez votre message" rows="4" data-error="Entrez votre message" required></textarea>
                                        <div class="help-block with-errors"></div>
                                    </div>
				...
				<div class="col-lg-4 col-sm-12">
                    <div class="contact-info-left">
                        <h2>INFO CONTACT</h2>
                        <p>Vous pouvez aussi nous joindre plus rapidement pour plus de reactivité. </p>
                        <ul>
                            <li>
                                <p><i class="fas fa-map-marker-alt"></i>Address: Kmerfood I. Days 9000 <br>Milan,<br> KS 87213 </p>
                            </li>
                            <li>
                                <p><i class="fas fa-phone-square"></i>Telephone: <a href="tel:+33-888 705 770">+33-888 705 770</a></p>
                            </li>
                            <li>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-12 col-sm-12">
                        <div class="footer-link-contact">
                            ...
                            <ul>
                                <li>
                                    <p><i class="fas fa-map-marker-alt"></i>Address: Kmerfood I. Days 3756 <br>Milan Afro Street,<br> KS 67213 </p>
                                </li>
                                <li>
